...
#LEG=[ r'$ N=12 \, D=1.3 \mu m^2/s \, \pi_o=5$',r'$ N=12 \, D=1.3 \mu m^2/s \, \pi_o=50$',r'$ N=12 \, D=1.3 \mu m^2/s \, \pi_o=200$',r'$ N=12 \, D=1.3 \mu m^2/s \, \pi_o=800$',r'$ N=12 \, D=1.3 \mu m^2/s \, PRE MODEL$']
...
def msd_single(SIMS,LEG):
    ...
    for count in range(len(SIMS)):
        ...
        r.curdir=r.curdir=r.chandra+"msd_05_Dec"
        r.mkdir(r.curdir)
        r.curdir=r.curdir+"/AM_test_bigarr"
        r.mkdir(r.curdir)
...
Parallel(n_jobs=num_cores)(delayed(msd_single)([SIMS[num]],[SIMS[num]]) for num in range(len(SIMS)))
